    ...
    <div className="forms">
      <Form className="urlForm">
        <Form.Input
          ...
          placeholder="url"
          value={link.url}
          onChange={handleChange('url', updateLinkForm)}
          onBlur={handleLinkBlur(link.url, findLink)}
        />
      </Form>
      <Form className="detailForm">
        <Form.Input
          ...
          placeholder="title"
          value={link.title}
          onChange={handleChange('title', updateLinkForm)}
        />
        <Form.Input
          label="Description:"
          control="input"
          ...
          onChange={handleChange('description', updateLinkForm)}
        />
        <Form.Input
          label="Tags:"
          control="input"
          placeholder="tags"
          value={link.tags}
          onChange={handleChange('tags', updateLinkForm)}
        />
        <Form.Input
          label="Image:"
          control="input"
          ...
          value={link.image}
          onChange={handleChange('image', updateLinkForm)}
        />
      </Form>
    </div>
    <div className="buttons">
      <Button.Group>
        <Button negative onClick={handleDelete(link, removeLink)}>
          Delete
        </Button>
        <Button.Or />
        <Button positive onClick={handleSave(link, saveLink)}>
          Save
        </Button>
      </Button.Group>
    </div>
